  ...
  return (
    <div className="relative w-full h-[90vh] bg-black">
      ...
      >
        ...
        {/* Explore Button */}
        <div
          className={`text-white text-sm md:text-base font-light flex items-center space-x-2 cursor-pointer hover:text-white/70 transition-colors ${!hasEverActivated ? 'animate-pulse' : ''}`}
          onClick={() => {
            if (!hasEverActivated) {
              setHasEverActivated(true);
              setMapActivated(true);
